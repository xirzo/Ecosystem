...
{
    public class PredatorFoundFood : EntityState
    {
        public override string Name => "Predator Found Food";

        private EntityInteractor _interactor;
        private EntityMovement _movement;
        private IInteractable _interactable;

        public PredatorFoundFood(EntityStateMachine stateMachine, EntityInteractor interactor, EntityMovement movement) : base(stateMachine)
        {
